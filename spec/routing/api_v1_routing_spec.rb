...
describe "api_v1" do
  describe "routing" do
    ...
    describe "posts" do
      ...
      #  get("/v1/posts/1/replies").should route_to("v1/posts#replies", :id => "1")
      #end
      ...
      it "routes to #unlike" do
        post("/v1/posts/1/unlike").should route_to("v1/posts#unlike", :id => "1")
      end

      it "routes to #create_reply" do
        post("/v1/posts/1/replies").should route_to("v1/posts#create_reply", :id => "1")
      end
