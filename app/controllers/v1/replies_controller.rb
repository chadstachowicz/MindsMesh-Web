class V1::RepliesController < V1::BaseController
  ...
  def likes
    render json: V1::LikePresenter.array(reply.likes)
  end

  def likes_with_parents
    render json: V1::LikePresenter.array(reply.likes).map(&:with_parents)
  end
